...
I = cv2.imread('output/gaussian_orig.png', cv2.IMREAD_GRAYSCALE)
axs[0].imshow(I, cmap='gray', vmin=0, vmax=255)
axs[0].set_title('Ảnh gốc')

# Đọc ảnh nhiễu Gauss và hiển thị
J = cv2.imread('output/gaussian_noise.png', cv2.IMREAD_GRAYSCALE)
...
# Lưu ảnh đã lọc
cv2.imwrite('output/gaussian_denoised_rpi3.png', K)
